...
node {
    def ARTIFACTS_PATH = 'build/*/lua5.*/luasql/targets/jonchki/repository/com/github/keplerproject/luasql/*'
        ...
        stage(atEntry[0]){
            docker.image("${atEntry[2]}").inside('-u root') {
                ...
                checkout([$class: 'GitSCM',
                    ...
                    submoduleCfg: [],
                    userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/com.github.keplerproject.luasql.git']]
                ])
