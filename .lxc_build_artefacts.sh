...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/com.github.keplerproject-lua*-luasql/targets/jonchki/repository/com/github/keplerproject/luasql/*" -type f'`
echo ${FILELIST}
